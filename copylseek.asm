...
_copylseek:     file format elf32-i386
...
int main(int argc, char *argv[]) {
  ...
  1a:	89 45 e4             	mov    %eax,-0x1c(%ebp)
	if(argc < 2) {
  1d:	0f 8e ed 00 00 00    	jle    110 <main+0x110>
  ...
  26:	51                   	push   %ecx
	int fd1, fd2, i, off, len = -1;
  27:	83 ce ff             	or     $0xffffffff,%esi
	fd1 = open(argv[1], O_RDONLY);
  2a:	51                   	push   %ecx
  2b:	6a 00                	push   $0x0
  2d:	ff 70 04             	pushl  0x4(%eax)
  30:	e8 8d 03 00 00       	call   3c2 <open>
	while(lseek(fd1, 1) != -1)
  35:	83 c4 10             	add    $0x10,%esp
	fd1 = open(argv[1], O_RDONLY);
  38:	89 c3                	mov    %eax,%ebx
	while(lseek(fd1, 1) != -1)
  3a:	eb 06                	jmp    42 <main+0x42>
  3c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  40:	89 d6                	mov    %edx,%esi
  42:	83 ec 08             	sub    $0x8,%esp
  45:	6a 01                	push   $0x1
  47:	53                   	push   %ebx
  48:	e8 d5 03 00 00       	call   422 <lseek>
  4d:	83 c4 10             	add    $0x10,%esp
  50:	83 f8 ff             	cmp    $0xffffffff,%eax
  53:	8d 56 01             	lea    0x1(%esi),%edx
  56:	75 e8                	jne    40 <main+0x40>
		len++;
	close(fd1);
  58:	83 ec 0c             	sub    $0xc,%esp
  5b:	53                   	push   %ebx
  5c:	e8 49 03 00 00       	call   3aa <close>
	
	off = len / 9;
  61:	89 f0                	mov    %esi,%eax
  63:	b9 09 00 00 00       	mov    $0x9,%ecx
	char s[len + 1];
  ...
  6e:	89 c7                	mov    %eax,%edi
	char s[len + 1];
  70:	8d 46 10             	lea    0x10(%esi),%eax
  73:	83 e0 f0             	and    $0xfffffff0,%eax
  76:	29 c4                	sub    %eax,%esp
  78:	89 e3                	mov    %esp,%ebx

	fd2 = open("copy", O_CREATE | O_WRONLY);
  7a:	51                   	push   %ecx
  7b:	51                   	push   %ecx
  7c:	68 01 02 00 00       	push   $0x201
  81:	68 58 08 00 00       	push   $0x858
  86:	e8 37 03 00 00       	call   3c2 <open>
  ...
  92:	5a                   	pop    %edx
  93:	6a 00                	push   $0x0
  95:	ff 70 04             	pushl  0x4(%eax)
  98:	e8 25 03 00 00       	call   3c2 <open>
  9d:	89 45 e4             	mov    %eax,-0x1c(%ebp)
  a0:	b8 09 00 00 00       	mov    $0x9,%eax
  a5:	89 75 dc             	mov    %esi,-0x24(%ebp)
  ...
  b8:	e8 dd 02 00 00       	call   39a <read>
		write(fd2, s, off);
  bd:	83 c4 0c             	add    $0xc,%esp
  c0:	57                   	push   %edi
  c1:	53                   	push   %ebx
  c2:	ff 75 e0             	pushl  -0x20(%ebp)
  c5:	e8 d8 02 00 00       	call   3a2 <write>
	for(i = 0; i < 9; i++) {
  ca:	83 c4 10             	add    $0x10,%esp
  cd:	83 ee 01             	sub    $0x1,%esi
  d0:	75 de                	jne    b0 <main+0xb0>
  d2:	8b 75 dc             	mov    -0x24(%ebp),%esi
	}
	off = len % 9;
  d5:	b9 09 00 00 00       	mov    $0x9,%ecx
  ...
  e1:	89 d6                	mov    %edx,%esi
	read(fd1, s, off);
  e3:	53                   	push   %ebx
  e4:	ff 75 e4             	pushl  -0x1c(%ebp)
  e7:	e8 ae 02 00 00       	call   39a <read>
	write(fd2, s, off);
  ec:	8b 7d e0             	mov    -0x20(%ebp),%edi
  ef:	83 c4 0c             	add    $0xc,%esp
  f2:	56                   	push   %esi
  f3:	53                   	push   %ebx
  f4:	57                   	push   %edi
  f5:	e8 a8 02 00 00       	call   3a2 <write>
	close(fd1);
  fa:	5a                   	pop    %edx
  fb:	ff 75 e4             	pushl  -0x1c(%ebp)
  fe:	e8 a7 02 00 00       	call   3aa <close>
	close(fd2);
 103:	89 3c 24             	mov    %edi,(%esp)
 106:	e8 9f 02 00 00       	call   3aa <close>
	exit();
 10b:	e8 72 02 00 00       	call   382 <exit>
		printf(1, "provide more arguments i.e ./test2 filename\n");
 110:	53                   	push   %ebx
 111:	53                   	push   %ebx
 112:	68 28 08 00 00       	push   $0x828
 117:	6a 01                	push   $0x1
 119:	e8 b2 03 00 00       	call   4d0 <printf>
		exit();
 11e:	e8 5f 02 00 00       	call   382 <exit>
...
printf(int fd, const char *fmt, ...)
{
 ...
 684:	e9 8f fe ff ff       	jmp    518 <printf+0x48>
          s = "(null)";
 689:	bb 5d 08 00 00       	mov    $0x85d,%ebx
        while(*s != 0){
 ...
 6a1:	a1 14 0b 00 00       	mov    0xb14,%eax
{
 ...
 6dd:	89 08                	mov    %ecx,(%eax)
  freep = p;
 6df:	a3 14 0b 00 00       	mov    %eax,0xb14
}
 6e4:	5b                   	pop    %ebx
 6e5:	5e                   	pop    %esi
 6e6:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
 ...
 739:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 73c:	8b 15 14 0b 00 00    	mov    0xb14,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 77f:	73 47                	jae    7c8 <malloc+0x98>
    ...
    if(p == freep)
 781:	39 05 14 0b 00 00    	cmp    %eax,0xb14
 ...
 7a6:	e8 f5 fe ff ff       	call   6a0 <free>
  return freep;
 7ab:	8b 15 14 0b 00 00    	mov    0xb14,%edx
 ...
 7d4:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 7d7:	89 15 14 0b 00 00    	mov    %edx,0xb14
}
 ...
 7e9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    base.s.ptr = freep = prevp = &base;
 7f0:	c7 05 14 0b 00 00 18 	movl   $0xb18,0xb14
 7f7:	0b 00 00 
 7fa:	c7 05 18 0b 00 00 18 	movl   $0xb18,0xb18
 801:	0b 00 00 
    base.s.size = 0;
 804:	b8 18 0b 00 00       	mov    $0xb18,%eax
 809:	c7 05 1c 0b 00 00 00 	movl   $0x0,0xb1c
 810:	00 00 00 
