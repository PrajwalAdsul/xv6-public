...
_readlseek:     file format elf32-i386
...
int main(int argc, char *argv[]) {
  ...
  a2:	56                   	push   %esi
  a3:	e8 92 02 00 00       	call   33a <close>
	exit();
  a8:	e8 65 02 00 00       	call   312 <exit>
		printf(1, "equal strings\n");
  ad:	52                   	push   %edx
  ae:	52                   	push   %edx
  af:	68 00 08 00 00       	push   $0x800
  b4:	6a 01                	push   $0x1
  b6:	e8 a5 03 00 00       	call   460 <printf>
  bb:	83 c4 10             	add    $0x10,%esp
  be:	eb df                	jmp    9f <main+0x9f>
 ...
 3c9:	85 d2                	test   %edx,%edx
{
 ...
 3f7:	f7 f1                	div    %ecx
 3f9:	0f b6 92 18 08 00 00 	movzbl 0x818(%edx),%edx
  }while((x /= base) != 0);
...
printf(int fd, const char *fmt, ...)
{
 ...
 614:	e9 8f fe ff ff       	jmp    4a8 <printf+0x48>
          s = "(null)";
 619:	bb 0f 08 00 00       	mov    $0x80f,%ebx
        while(*s != 0){
 ...
 631:	a1 c8 0a 00 00       	mov    0xac8,%eax
{
 ...
 66d:	89 08                	mov    %ecx,(%eax)
  freep = p;
 66f:	a3 c8 0a 00 00       	mov    %eax,0xac8
}
 674:	5b                   	pop    %ebx
 675:	5e                   	pop    %esi
 676:	5f                   	pop    %edi
 ...
 686:	72 ce                	jb     656 <free+0x26>
{
 ...
 6a7:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 6aa:	a3 c8 0a 00 00       	mov    %eax,0xac8
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6c9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6cc:	8b 15 c8 0a 00 00    	mov    0xac8,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 70f:	73 47                	jae    758 <malloc+0x98>
    ...
    if(p == freep)
 711:	39 05 c8 0a 00 00    	cmp    %eax,0xac8
 ...
 736:	e8 f5 fe ff ff       	call   630 <free>
  return freep;
 73b:	8b 15 c8 0a 00 00    	mov    0xac8,%edx
 ...
 764:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 767:	89 15 c8 0a 00 00    	mov    %edx,0xac8
}
 ...
 787:	0a 00 00 
 78a:	c7 05 cc 0a 00 00 cc 	movl   $0xacc,0xacc
 791:	0a 00 00 
    base.s.size = 0;
 794:	b8 cc 0a 00 00       	mov    $0xacc,%eax
 799:	c7 05 d0 0a 00 00 00 	movl   $0x0,0xad0
 7a0:	00 00 00 
