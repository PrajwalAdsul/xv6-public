...
80105485:	83 ec 18             	sub    $0x18,%esp
  if(argfd(0, 0, &fd) < 0)
80105488:	8d 55 f4             	lea    -0xc(%ebp),%edx
8010548b:	e8 b0 f5 ff ff       	call   80104a40 <argfd.constprop.0>
80105490:	85 c0                	test   %eax,%eax
80105492:	78 60                	js     801054f4 <sys_lseek+0x74>
    return -1;
...
8010549d:	e8 ae f2 ff ff       	call   80104750 <argint>
801054a2:	83 c4 10             	add    $0x10,%esp
801054a5:	85 c0                	test   %eax,%eax
801054a7:	78 4b                	js     801054f4 <sys_lseek+0x74>
    return -1;
...
801054af:	ff 70 10             	pushl  0x10(%eax)
801054b2:	e8 c9 c1 ff ff       	call   80101680 <ilock>
  // if offset is going beyond file size then return -1
  // indicating a terminal condition
  if(fd->off + offset >= fd->ip->size)
801054b7:	8b 4d f4             	mov    -0xc(%ebp),%ecx
801054ba:	8b 45 f0             	mov    -0x10(%ebp),%eax
801054bd:	83 c4 10             	add    $0x10,%esp
801054c0:	8b 51 10             	mov    0x10(%ecx),%edx
801054c3:	03 41 14             	add    0x14(%ecx),%eax
801054c6:	3b 42 58             	cmp    0x58(%edx),%eax
801054c9:	73 1d                	jae    801054e8 <sys_lseek+0x68>
    iunlock(fd->ip);
    return -1;
  }
...
801054cf:	e8 8c c2 ff ff       	call   80101760 <iunlock>
...
801054da:	83 c4 10             	add    $0x10,%esp
  fd->off = fd->off + offset;
801054dd:	03 42 14             	add    0x14(%edx),%eax
801054e0:	89 42 14             	mov    %eax,0x14(%edx)
}
801054e3:	c9                   	leave  
801054e4:	c3                   	ret    
